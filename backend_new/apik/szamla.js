    ...
    app.post('/api/Szamla_create', /*authenticateToken,*/ async (req, res) => {
        try {
            ...
            if (headerData.szamla_sz) {
                ...
                // Számlaszám generálása a szamla_minta alapján
            ...
            const filename = `Szamla_${szamlaSorszam}.pdf`;
            ...
            const drawHeader = () => {
                ...
                doc.fontSize(12).font('CustomFont').text(`Sorszám: ${szamlaSorszam}`, { align: 'left' });
