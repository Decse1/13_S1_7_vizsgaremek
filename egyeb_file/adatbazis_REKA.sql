...
ALTER TABLE `Termek` ADD FOREIGN KEY (`id`) REFERENCES `Rendeles_tetel` (`termek_id`);

ALTER TABLE `Rendeles_tetel` ADD FOREIGN KEY (`rendeles_id`) REFERENCES `Rendeles` (`id`);
